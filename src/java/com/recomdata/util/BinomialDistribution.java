...
/**
 * Models the binomial distribution with a specified number of trials and
...
public class BinomialDistribution extends Distribution implements Serializable {
	...
	/**
	 * Creates the binomial distribution with a specified number of trials and probability of success.
	 *
	...
	/**
	 * Creates the binomial distribution with 10 trials and probability of success 0.5.
	 */
	...
	/**
	 * Sets the number of trials and the probability of success, and computes the default domain.
	 */
	...
	/**
	 * Computes the probability  density function in terms of the number of trials and the probability of success.
	 *
	...
	/**
	 * Computes the mean in terms of the number of trials and the probability of success.
	 *
	 * @return the mean
	 */
	...
	/**
	 * Computes the variance in terms of the probability of success and the number of trials.
	 *
	 * @return the variance
	 */
	...
	/**
	 * Computes the cumulative distribution function in terms of the beta cumulative distribution function.
	 *
	...
	public double getCDF(double x) {
		if (x < 0) {
			...
			return 1 - Functions.betaCDF(probability, x + 1, trials - x);
		}
	}

	/**
	 * Simulates the a value from the distribution. This is done by simulating the
	 * Bernoulli trials and counting the number of successes.
	 *
	...
	/**
	 * Computes the probability generating function in terms of the number of trials and the probability of success.
	 *
	...
	/**
	 * Computes the moment generating function in terms of the probability generating function.
	 *
	 * @param t a real number
	...
	/**
	 * Rreturns the factorial moment of a specified order.
	 *
	 * @param k the order
	...
	/**
	 * Returns a string that gives the name of the distribution and the values of the parameters.
	 *
