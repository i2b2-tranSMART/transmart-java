...
/**
 * Defines a partition of an interval into subintervals of equal width.
...
public class Domain implements Serializable {
	...
	/**
	 * Creates a new partition of a specified interval [a, b] into subintervals of width w.
	 * The underlying variable has a specified name and symbol.
	 *
	...
	/**
	 * Creates a new domain on (0, 1) with step size 0.1
	 */
	public Domain() {
		this(0, 1, 0.1, 1);
	}
	...
	/**
	 * The type of the domain (DISCRETE or CONTINUOUS).
	 *
	 * @return the type
	 */
	public int getType() {
	...
	/**
	 * The index of the interval containing a given value.
	 *
	...
	/**
	 * The boundary point corresponding to a given index.
	 *
	 * @param i the index
	 */
	...
	/**
	 * The midpoint of the interval corresponding to a given index.
	 *
	 * @param i the index
	...
	/**
	 * The lower midpoint of the domain.
	 *
	...
	/**
	 * The upper midpoint of the domain.
	 *
	...
	/**
	 * The size of the partition (the number of subintervals).
	 *
	...
	/**
	 * The value (midpoint) that is closest to a given value.
	 *
	 * @param x a number in the domain
