...
/**
 * Assistance for downloading domain object instances to Excel from the internet.
 *
 * @author jspencer
 */
public class DomainObjectExcelHelper {
	...
	private IDomainExcelWorkbook domainObject;

	public DomainObjectExcelHelper(IDomainExcelWorkbook workbook, String title) {
		domainObject = workbook;
		fileName = title;
	}
	...
	public void downloadDomainObject(HttpServletResponse response) throws IOException {
		...
		try {
			...
			os.write(domainObject.createWorkbook());
		}
		finally {
			os.flush();
		}
