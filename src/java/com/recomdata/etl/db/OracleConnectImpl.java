...
public class OracleConnectImpl implements DBConnect {
	...
	public OracleConnectImpl(String serverName, String databaseName, String portNumber, String userName, String password) {
		super();
	...
	public OracleConnectImpl(String serverName, String databaseName, String userName, String password) {
		super();
		this.databaseName = databaseName;
		this.password = password;
		this.serverName = serverName;
